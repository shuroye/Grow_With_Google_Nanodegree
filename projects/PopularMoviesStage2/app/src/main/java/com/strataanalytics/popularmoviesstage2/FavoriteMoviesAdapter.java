...
public  class FavoriteMoviesAdapter extends RecyclerView.Adapter <FavoriteMoviesAdapter.ViewHolder> {
    ...
    private List<FavoriteMovies> movieList;

    private LayoutInflater  layoutInflater;
    private  Context context;
    // data is passed into the constructor
     FavoriteMoviesAdapter(Context context, List<FavoriteMovies> movieList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FavoriteMovies strMovie =  movieList.get(position);

        Context context = holder.imageView.getContext();
        Picasso.with(context)
                .load(String.valueOf(strMovie.getFav()))
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            try {
                ...
                favoriteMovies = movieList.get(getLayoutPosition());

                GetMoviePreferences getMoviePreferences = new GetMoviePreferences(favoriteMovies.getFavPos());
